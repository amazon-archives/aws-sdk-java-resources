...
class UserCollectionImpl implements UserCollection {
    ...
    public UserCollectionImpl(ResourceCollectionImpl impl) {
        this.impl = impl;
    }

    @Override
    public Iterator<User> iterator() {
        return new StandardResourceIterator<User>(impl.iterator(),
                UserImpl.CODEC);
    }

    @Override
    public Iterable<ResourcePage<User>> pages() {
        return new StandardPageIterable<User>(impl.pages(), UserImpl.CODEC);
    }

    @Override
    public ResourcePage<User> firstPage() {
        return firstPage(null);
    }

    @Override
    public ResourcePage<User> firstPage(ResultCapture<Object> extractor) {
        return new StandardResourcePage<User>(impl.firstPage(extractor),
                UserImpl.CODEC);
    }
}
